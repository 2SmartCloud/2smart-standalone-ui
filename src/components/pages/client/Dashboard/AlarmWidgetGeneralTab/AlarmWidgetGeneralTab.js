...
import { ALARM_WIDGET_TOPICS }      from '../../../../../assets/constants/widget';
...
class AlarmWidgetGeneralTab extends Component {
    static propTypes = {
    ...
    renderEntities = () => {
        ...
        return  ALARM_WIDGET_TOPICS.map(({ order, hardwareLabel, isRetained, isSettable }) => {
    ...
    render() {
        ...
        return (
            <div className={styles.AlarmWidgetGeneralTab}>
                <GeneralTab
                    topics             = {topics}
...
export default connect(mapStateToProps, { ...WidgetActions })(AlarmWidgetGeneralTab);
