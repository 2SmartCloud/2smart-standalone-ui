...
import styles from './AttachTab.less';

class AttachTab extends PureComponent {
    static propTypes = {
            ...
            <div className={styles.AttachTab}>
                <MultiSelect
                    ...
                    classes={{
                        ...
                        valuesContainer : styles.valuesWrapper
                    }}
...
export default connect(mapStateToProps, { ...InterfaceActions, ...GroupsActions, ...HomieActions })(AttachTab);
