...
const CronValidator = (function () {
    ...
    const MeasureOfTimeMap = {
         ...
         * @type {Array}
         */
    const MeasureOfTimeValues = Object.keys(MeasureOfTimeMap).map((key) => {
     ...
     */
    const validateString = function (expression) {
     ...
     */
    const validateValue = function (measureOfTime, value) {
        const validatorObj = {
            minute        : { min: 0, max: 59 },
            hour          : { min: 0, max: 23 },
...
const CronBuilder = (function () {
    function CronBuilder(initialExpression) {
        ...
        this.addValue = function (measureOfTime, value) {
            ...
            } else if (expression[measureOfTime].indexOf(value) < 0) {
        ...
        this.removeValue = function (measureOfTime, value) {
            ...
            expression[measureOfTime] = expression[measureOfTime].filter((timeValue) => {
...
module.exports.CronValidator = CronValidator;
